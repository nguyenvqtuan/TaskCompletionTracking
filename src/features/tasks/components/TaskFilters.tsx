  ...
  return (
    <div className={cn("flex flex-col sm:flex-row items-start sm:items-center gap-2", className)}>
        ...
        <div className="flex items-center border rounded-md p-0.5 bg-background">
          <Button
            ...
            className={cn(
              ...
              viewMode === "grid" ? "bg-muted/50" : "text-muted-foreground hover:text-foreground",
            )}
          >
          ...
          <Button
            ...
            className={cn(
              "h-8 w-8 p-0 rounded-sm",
              viewMode === "list" ? "bg-muted/50" : "text-muted-foreground hover:text-foreground",
            )}
          >
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
        {/* Search */}
        <SearchBar value={filters.search} onChange={(v) => onUpdate({ search: v })} className="w-auto" />
